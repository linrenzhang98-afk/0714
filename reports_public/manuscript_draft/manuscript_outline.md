...
1. **Introduction:** incompatible ecological definitions; community structure as a generalizable level; common measurement without pooled estimands; two linked questions.
...
Four main figures and three main tables are defined in `figure_blueprint.md` and `table_blueprint.md`. Supplementary material contains the complete 5/10/20% sensitivity grid, PERMDISP, method versions, feature-filter counts, missingness/provenance and—only after a separate decision—exploratory DA.
